...
function ListingClient({currentUser,listing,reservations=[]} : ListingClientProps) {
  ...
  return (
    <Container>
      <div className='max-w-screen-lg mx-auto'>
        ...
        currentUser={currentUser} id={listing.id}/>
        <div className='grid grid-cols-1 md:grid-cols-7 md:gap-10 mt-6'>
          <ListingInfo user={listing.user} category={category} description={listing.description}
          locationValue={listing.locationValue} roomCount={listing.roomCount} guestCount={listing.guestCount}
          bathroomCount={listing.bathroomCount}/>
          <div className='order-first mb-10 md:order-last md:col-span-3'>
            <ListingReservation price={listing.price} totalPrice={totalPrice} dateRange={dataRange}
            onChangeDate={(value) => setDataRange(value)} onSubmit={onCreateReservation} disabled={isLoading}
